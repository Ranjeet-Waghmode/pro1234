...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        arduino_update()
        self.label_7.setText(_translate("MainWindow", f"{backLeftDoor}"))
        self.label_5.setText(_translate("MainWindow", f"{frontRightDoor}"))
        self.label_4.setText(_translate("MainWindow", f"{frontLeftDoor}"))
        self.label_8.setText(_translate("MainWindow", f"{frontBonnet}"))
        self.label_9.setText(_translate("MainWindow", f"{backBonnet}"))
        self.label_6.setText(_translate("MainWindow", f"{backRightDoor}"))
        self.label_14.setText(_translate("MainWindow",f"Fuel:"))
        self.label_15.setText(_translate("MainWindow",f"Door locked"))
        self.label_16.setText(_translate("MainWindow",f"Rolls Royce Phantom"))
        self.labelPercentageCPU.setText(_translate("MainWindow", f"<html><head/><body><p>{weather.temp_celsius:.0f}°C</p></body></html>"))
        ...
        self.labelPercentageCPU_4.setText(_translate("MainWindow", f"<html><head/><body><p>{weather.weather_condition}</p></body></html>"))
        self.labelPercentageCPU_3.setText(_translate("MainWindow", f"<html><head/><body><p>{temperature}°C</p></body></html>"))
        ...
        self.label_33.setText(_translate("MainWindow", "02. Play"))
...
#         self.timer.start(1000)  # Update every second
    ...
    def update_gauges(self):
        ...
        self.date.setText(datetime.now().strftime("%I: %M: %S  %p"))
        arduino_update()
        self.label_7.setText(f"{backLeftDoor}")
        self.label_5.setText(f"{frontRightDoor}")
        self.label_4.setText(f"{frontLeftDoor}")
        self.label_8.setText(f"{frontBonnet}")
        self.label_9.setText(f"{backBonnet}")
        self.label_6.setText(f"{backRightDoor}")
        self.label_14.setText(f"Fuel:")
        self.label_15.setText(f"Door locked")
        self.label_16.setText(f"Rolls Royce Phantom")
        self.labelPercentageCPU.setText(f"<html><head/><body><p>{weather.temp_celsius:.0f}°C</p></body></html>")
        self.label_19.setText(f"Outdoor\nTemperature")
        self.labelPercentageCPU_3.setText(_translate("MainWindow", f"<html><head/><body><p>{temperature}°C</p></body></html>"))
        
        # self.label_7.setText(f"{frontLeftDoor}")
        # self.label_5.setText(f"{frontRightDoor}")       
        # self.label_4.setText(f"{backLeftDoor}")
        # self.label_8.setText(f"{backRightDoor}")
        # self.label_9.setText(f"{frontBonnet}")
        # self.label_6.setText(f"{backBonnet}")
        # self.label_14.setText(f"Fuel:")
        # self.label_15.setText(f"Door locked")
        # self.label_16.setText(f"Rolls Royce Phantom")
        # self.labelPercentageCPU.setText(f"<html><head/><body><p>{weather.temp_celsius:.0f}°C</p></body></html>")
