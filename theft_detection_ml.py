...
def load_and_preprocess_data(file_path):
    ...
    data['doorActivity'] = (data['frontLeftDoor'] + data['frontRightDoor'] + 
                            ...
                            data['frontBonnet'] + data['backBonnet'])
    ...
    features = ['frontLeftDoor', 'frontRightDoor', 'backLeftDoor', 'backRightDoor', 'frontBonnet', 
                'backBonnet', 'temperature', 'gasDetected', 'motionDetected', 'lat', 'lon', 'speed',
...
def run_theft_detection_system(file_path):
    ...
    if not anomalies.empty:
        ...
        anomalies.to_csv(os.path.join(os.path.dirname(__file__), 'detected_anomalies.csv') , index=False)
...
def theft_detection_main():
    run_theft_detection_system(file_path = os.path.join(os.path.dirname(__file__), "car_Arduino_data.csv"))
